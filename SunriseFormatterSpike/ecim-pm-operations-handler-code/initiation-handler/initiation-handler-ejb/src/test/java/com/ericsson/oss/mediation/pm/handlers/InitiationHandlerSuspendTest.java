...
public class InitiationHandlerSuspendTest extends BaseInitiationHandlerTest implements InitiationHandlerTestInterface {
	...
	public void prepareEvent() {
    	final MediationTaskRequest suspendRequest = new StatisticsPMDeactivationJob(PMEventConstants.EVENT_TYPE_SCANNER_SUSPENSION, "NetworkElement=node", "jobId", "scannerName", "scannerName", "scannerFdn");

        eventHeader.put("mediationTaskRequest", suspendRequest);
        eventHeader.put(NetconManagerConstants.NETCONF_MANAGER_ATTR, netconfManager);
	}
	
    private void testSuspendWithNetconfOperationFailed() {
    	prepareEvent();
    ...
    public void testonEvent() {
        ...
        assertEquals(eventHeader.get(SCANNER_ID_HEADER_PARAM_KEY), outputHeaders.get(NODE_SCANNER_ID));
        assertEquals(STATUS_INACTIVE, outputHeaders.get(SCANNER_STATUS));
    ...
    public void testonEventWhenLockFail() {
    	...
    	testSuspendWithNetconfOperationFailed();
    }
    ...
    public void testonEventWhenJAXBException() {
    	...
    	Whitebox.setInternalState(suspensionStrategy, "pmFactory", factory);
