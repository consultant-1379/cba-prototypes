...
/**
 * Class responsible for providing the call to activate a
 * scanner on a node
 * 
 * 
 */
@StrategyQualifier(type = StrategyType.ACTIVATION)
public class ActivationStrategy extends BaseOperationStrategyImpl {

    private final static Logger log = LoggerFactory.getLogger(ActivationStrategy.class);
    ...
    public void executeOperation(final Map<String, Object> eventHeaders) throws PerformanceMonitoringException {
        ...
        activator.activatePerformanceMonitoring(eventHeaders);

        log.info("Executed activation strategy...");
    }
