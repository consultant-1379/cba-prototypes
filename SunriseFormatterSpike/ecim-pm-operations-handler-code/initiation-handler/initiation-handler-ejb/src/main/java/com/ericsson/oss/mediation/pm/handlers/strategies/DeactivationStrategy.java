...
/**
 * Class responsible for providing the call to delete a
 * scanner on a node
 * 
 * 
 */
@StrategyQualifier(type = StrategyType.DEACTIVATION)
public class DeactivationStrategy extends BaseOperationStrategyImpl {
    private final static Logger log = LoggerFactory.getLogger(DeactivationStrategy.class);
    ...
    public void executeOperation(final Map<String, Object> eventHeaders) throws PerformanceMonitoringException {
        ...
        deactivator.deactivatePerformanceMonitoring(eventHeaders);

        log.info("Executed deactivation strategy...");
    }
