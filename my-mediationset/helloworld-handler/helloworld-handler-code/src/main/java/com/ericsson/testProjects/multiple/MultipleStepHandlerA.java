 ...
 */
@EventHandler
public class MultipleStepHandlerA implements EventInputHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(MultipleStepHandlerA.class);
    ...
    public Object onEventWithResults(Object object) {
        ...
        final File file = new File("target/MultipleStepHandlerA.txt");
        try {
            file.createNewFile();
            final FileWriter fileWriter = new FileWriter(file);
            fileWriter.write("MultipleStepHandlerA File is created");
            fileWriter.flush();
            fileWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
