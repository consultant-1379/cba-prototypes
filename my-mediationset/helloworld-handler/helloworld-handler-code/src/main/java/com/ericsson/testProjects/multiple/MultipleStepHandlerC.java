 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.testProjects.multiple;
 ...
 */
@EventHandler
public class MultipleStepHandlerC implements EventInputHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(MultipleStepHandlerC.class);
    ...
    public Object onEventWithResults(Object object) {
        ...
        final File file = new File("target/MultipleStepHandlerC.txt");
        try {
            file.createNewFile();
            final FileWriter fileWriter = new FileWriter(file);
            fileWriter.write("MultipleStepHandlerC File is created");
            fileWriter.flush();
            fileWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
