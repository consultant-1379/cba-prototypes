 ...
 */
@EventHandler
public class OutputHandlerA implements TypedEventInputHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(OutputHandlerA.class);
    ...
    public ComponentEvent onEvent(final ComponentEvent componentEvent) {
    	...
    	final List<String> handlerTraverse = new ArrayList<String>();
