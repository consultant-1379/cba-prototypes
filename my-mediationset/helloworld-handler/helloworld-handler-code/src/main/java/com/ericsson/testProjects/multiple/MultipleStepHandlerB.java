 ...
 */
@EventHandler
public class MultipleStepHandlerB implements EventInputHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(MultipleStepHandlerB.class);
    ...
    public Object onEventWithResults(Object object) {
        ...
        final File file = new File("target/MultipleStepHandlerB.txt");
        try {
            file.createNewFile();
            final FileWriter fileWriter = new FileWriter(file);
            fileWriter.write("MultipleStepHandlerB File is created");
            fileWriter.flush();
            fileWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
